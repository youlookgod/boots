...
public class HciCloudSysHelper {
    ...
    public static String appKey = "745d54c3";
    public static String developerKey = "ba1a617ff498135a324a109c89db2823";
    public static String cloudUrl = "api.hcicloud.com:8888";
    public static String capKey = "tts.cloud.liangjiahe";
    ...
    private InitParam getInitParam() {
        ...
        // 灵云云服务的接口地址，此项必填
        initparam.addParam(InitParam.AuthParam.PARAM_KEY_CLOUD_URL,cloudUrl);

        // 开发者Key，此项必填，由捷通华声提供
        initparam.addParam(InitParam.AuthParam.PARAM_KEY_DEVELOPER_KEY,developerKey);

        // 应用Key，此项必填，由捷通华声提供
        initparam.addParam(InitParam.AuthParam.PARAM_KEY_APP_KEY, appKey);
